        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Favicon = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Email = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Address = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    WorkingHours = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyColor = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    HeadingColor = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    FontFamily = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    HeadingFont = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    BorderRadius = table.Column<int>(type: "INTEGER", nullable: false),
                    ButtonRadius = table.Column<int>(type: "INTEGER", nullable: false),
                    ContainerWidth = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    VisitorKey = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWhatsApp = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingsJson = table.Column<string>(type: "TEXT", maxLength: 10000, nullable: true),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    IsVisible = table.Column<bool>(type: "INTEGER", nullable: false),
                    Animation = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    AnimationDuration = table.Column<int>(type: "INTEGER", nullable: true),
                    AnimationDelay = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
